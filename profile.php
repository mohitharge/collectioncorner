...
<div class="row">
	...
	?>
		...
		echo"
			...
			<p><strong>Collection Name: </strong> $collection_name</p><br>
		...
		while ($row_posts = mysqli_fetch_array($run_post)) {
			...
			if($content == "No" && strlen($upload_image) >= 1){
				...
				<div id='own_posts'>
					...
					<a href='functions\delete_post.php?post_id=$post_id' style='float:right; margin-right: 4px;'><button class='btn btn-danger'>Delete</button></a><br>	
